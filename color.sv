...
module color(
  ...
  begin
	...
	if(ebreak == 1'b1 || apagado == 1'b1)begin //si es o fue ebreak en algun punto todo acaba
			apagado = 1'b1;
			
			mensaje[0][0]  = "E"; mensaje[0][1]  = "L"; mensaje[0][2]  = " ";
			mensaje[0][3]  = "P"; mensaje[0][4]  = "R";
			mensaje[0][5]  = "G"; mensaje[0][6]  = "R";
			mensaje[0][7]  = "A"; mensaje[0][8]  = "M";
			mensaje[0][9]  = "A"; mensaje[0][10] = " ";
			mensaje[0][11] = "T"; mensaje[0][12] = "E";
			mensaje[0][13] = "R"; mensaje[0][14] = "M";
			mensaje[0][15] = "I"; mensaje[0][16] = "N"; mensaje[0][17]  = "O";
	end
